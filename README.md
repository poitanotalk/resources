...
A parte da **_condição_** é uma expressão [`Boolean`]() { verdadeiro | falso }. As expressões **_enquanto i < 10_** ou **_até i > 10_** são avaliadas como [`True`](), diferente de zero ou [`False`](), igual a zero.
