...
A parte da _condição_ é tipo Boolean [ { _verdadeiro_ | _falso_ } ]. As expressões **enquanto i < 10** ou **até i > 10** são avaliadas como [`True`](), diferente de zero, ou [`False`](), igual a zero.
