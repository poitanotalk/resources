...
A parte da _condição_ é do tipo Boolean [ { _verdadeiro_ | _falso_ } ]. As expressões _enquanto i < 10_ ou _até i > 10_ são avaliadas como [`True`](), diferente de zero, ou [`False`](), igual a zero.
